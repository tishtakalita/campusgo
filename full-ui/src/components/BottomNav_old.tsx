...
import { Home, MessageCircle, Folder, FolderOpen } from "lucide-react";
...
export function BottomNav({ onChatClick, onHomeClick, onResourcesClick, onProjectsClick, currentView }: BottomNavProps) {
  return (
